...
public class InicialThrow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        current_turn.setForeground(new java.awt.Color(204, 0, 0));
        current_turn.setText("JUGADOR");
        getContentPane().add(current_turn, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 80, -1, 61));
